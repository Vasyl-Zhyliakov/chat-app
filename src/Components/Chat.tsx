  ...
  return (
    <div className="chat">
        ...
        <div className="chat__messages">
          {messages.map((message) =>
            message.sender === Users.user ? (
              <div className="chat__message chat__message--user" key={message.id}>
                {message.text}
              </div>
            ) : (
              <div className="chat__message chat__message--bot" key={message.id}>
                {message.text}
              </div>
            )
          )}
      ...
      <div className="chat__footer">
        <form action="#" method="post" className="chat__form" onSubmit={handleSubmit}>
          <input
